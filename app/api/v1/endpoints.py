...
async def generate_d2(view: ProcessedView) -> str:
...
async def generate_mermaid(view: ProcessedView) -> str:
...
async def generate_puml(view: ProcessedView) -> str:
...
async def generate(view: ProcessedView, format: str) -> str:
